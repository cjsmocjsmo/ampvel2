...
/* src/routes/godzilla.svelte generated by Svelte v3.30.0 */

const { console: console_1 } = globals;
const file = "src/routes/godzilla.svelte";
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			attr_dev(img, "class", "svelte-l9o6gz");
			add_location(img, file, 57, 2, 1499);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(h1_nodes, "Godzilla");
		...
		h: function hydrate() {
			...
			attr_dev(button0, "class", "b1 svelte-l9o6gz");
			add_location(button0, file, 52, 1, 1387);
			attr_dev(h1, "class", "svelte-l9o6gz");
			add_location(h1, file, 53, 1, 1437);
			add_location(nav0, file, 51, 0, 1380);
			attr_dev(a1, "href", ".");
			add_location(a1, file, 61, 20, 1637);
			attr_dev(button1, "class", "b1 svelte-l9o6gz");
			add_location(button1, file, 61, 1, 1618);
			attr_dev(a2, "href", ".");
			add_location(a2, file, 62, 9, 1676);
			add_location(button2, file, 62, 1, 1668);
			add_location(nav1, file, 60, 0, 1611);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots("Godzilla", slots, []);
	let NewDat = [];

	onMount(async () => {
		await fetch(`http://192.168.0.42:8888/intGodzilla`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Godzilla> was created with unknown prop '${key}'`);
	});
...
class Godzilla extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
