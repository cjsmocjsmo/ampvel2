...
/* src/routes/jurassicpark.svelte generated by Svelte v3.30.0 */

const { console: console_1 } = globals;
const file = "src/routes/jurassicpark.svelte";
...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			...
			add_location(img, file, 57, 2, 1508);
		},
...
function create_fragment(ctx) {
	...
	const block = {
		...
		l: function claim(nodes) {
			...
			t2 = claim_text(h1_nodes, "Jurassic Park");
		...
		h: function hydrate() {
			attr_dev(a0, "href", ".");
			add_location(a0, file, 52, 20, 1410);
			attr_dev(button0, "class", "b1 svelte-r8m8ks");
			add_location(button0, file, 52, 1, 1391);
			attr_dev(h1, "class", "svelte-r8m8ks");
			add_location(h1, file, 53, 1, 1441);
			add_location(nav0, file, 51, 0, 1384);
			attr_dev(a1, "href", ".");
			add_location(a1, file, 61, 20, 1646);
			attr_dev(button1, "class", "b1 svelte-r8m8ks");
			add_location(button1, file, 61, 1, 1627);
			attr_dev(a2, "href", ".");
			add_location(a2, file, 62, 9, 1685);
			add_location(button2, file, 62, 1, 1677);
			add_location(nav1, file, 60, 0, 1620);
		},
		m: function mount(target, anchor) {
...
function instance($$self, $$props, $$invalidate) {
	...
	validate_slots("Jurassicpark", slots, []);
	let NewDat = [];

	onMount(async () => {
		await fetch(`http://192.168.0.42:8888/intJurassicPark`, { mode: "cors", method: "GET" }).then(r => r.json()).then(data => {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Jurassicpark> was created with unknown prop '${key}'`);
	});
...
class Jurassicpark extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,
