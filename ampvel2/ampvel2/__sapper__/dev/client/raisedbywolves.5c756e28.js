...
function create_each_block(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(span, "class", "svelte-x2dzjq");
			add_location(span, file, 79, 16, 2590);
			attr_dev(a, "href", "tvshows");
			attr_dev(a, "class", "svelte-x2dzjq");
			add_location(a, file, 80, 16, 2635);
			attr_dev(li, "class", "svelte-x2dzjq");
...
function create_fragment(ctx) {
	...
	const block = {
		...
		h: function hydrate() {
			attr_dev(h1, "class", "svelte-x2dzjq");
			...
			attr_dev(ul, "class", "svelte-x2dzjq");
