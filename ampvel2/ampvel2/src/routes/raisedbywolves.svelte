<script>
    ...
    let handleRaisedByWolves2 = () => {
        let promise = getRaisedByWolves(`02`).catch(err => console.log(err));
    }
...
<svg viewBox="0 0 273 35">
    ...
    <text on:click={handleRaisedByWolves1} x="48" y="18" font-size=".7em" fill="white">Season 1</text>
    <text on:click={handleRaisedByWolves2} x="177" y="18" font-size=".7em" fill="white">Season 2</text>
</svg> 
